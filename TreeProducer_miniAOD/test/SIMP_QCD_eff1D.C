...
// 	double QCD_events[5] = {16830696, 19199088, 15621634, 4980387, 3846616};
  ...
  TFile *output = new TFile("eff1D_QCD_photonVeto_PUMoriond17.root", "RECREATE");
...
// 			Double_t random1 = r.Uniform();
			...
			if (jet_pt[0] > 250 && jet_pt[1] > 250 && fabs(jet_eta[0]) < 2.0 && fabs(jet_eta[1]) < 2.0 && deltajet_phi > 2.0 && nPixHits > 0 && (passLooseId[0] == 0 || (passLooseId[0] == 1 && dR1 > 0.1 && dR2 > 0.1))){
